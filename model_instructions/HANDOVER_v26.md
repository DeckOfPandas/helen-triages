...
That's the whole list — `DEV_JOBS_v26.md` is retired as of 2026-08-10; Helen
moved the backlog to GitHub Issues, not a local file, so check there instead.
Run `ls model_instructions/` before trusting even this table anyway.
