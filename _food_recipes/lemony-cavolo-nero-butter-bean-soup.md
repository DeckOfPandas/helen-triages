...
method:
  ...
  - "Add the cavolo nero and the butter beans, including their liquid, then simmer for 6–8 mins until the greens are tender."
...
notes:
  ...
  - label: "Thicker texture"
    text: "Mash some of the beans with a fork before adding them if you want it thicker."
meta:
  rewritten: true
  proofread: false
  cooked_before: true
