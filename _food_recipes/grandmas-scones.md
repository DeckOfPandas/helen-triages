...
ingredient_groups:
  - items:
    ...
    - amount: "4 oz"
      item: sultanas
method:
  - "Rub the butter into the flour lightly with fingertips, adding a pinch of salt."
  - "Mix in the sugar then add the fruit."
  ...
  - "Cool for 5 mins on a wire rack before serving, as they won't be quite cooked through on coming out of the oven."
method_short:
  - ""
# notes:
#   -
