...
notes:
  ...
  - label: "How much this makes, in real uses"
    text: "Enough to glaze an 8-inch single-layer cake; to drip a tall 6-inch or 8-inch cake; for a thick filling for one 8-inch cake; to top a 16-cm square Millionaire's shortbread; to ice 12 cupcakes; or as the base for 16 luxury truffles. `serves_estimate` is set to the 8-inch cake, which is three of those six."
meta:
  rewritten: true
  awaiting_fix: false
  proofread: true
