...
ingredient_groups:
  - items:
    ...
    - amount: "3 tbsp"
      ...
      note: "so much better with fresh juice that it's not worth making this sauce without it"
    - amount: "4 large"
      item: egg yolks
    - item: salt
...
And a note on food safety: this starts out as raw egg. Don't let it sit too long in the temperature "danger zone" range, 8°C to 63°C, before serving.
